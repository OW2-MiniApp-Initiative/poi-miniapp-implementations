# _Heritage in…_ Oslo (Generated with Deepseek)

The _Heritage in…_ Oslo promotes the touristic places in Oslo, highlighted and retrieved by Deekseek, through open data and crowdsourcing. This is part of the [Heritage_in Quick App Project](https://ow2-miniapp-initiative.github.io/poi-miniapp/#Theproject).

Data could be inaccurate since it was AI-generated and formatted in minutes to demonstrate how AI can help in the first dataset in the app. 
...
Perhaps the content is inaccurate, so please [let us know](https://github.com/ow2-miniapp-initiative/poi-miniapp-implementations/issues/new?labels=nl/amsterdam) if you've spotted anything that might be enhanced. 
...
Feel free to [raise issues](https://github.com/ow2-miniapp-initiative/poi-miniapp-implementations/issues/new?labels=nl/amsterdam) on the code.
